...
__all__ = [
    'ISpStreamFormat', 'eWORDTYPE_DELETED', 'DISPID_SVGetProfiles',
    'ISpeechPhraseRule', 'DISPID_SAFType',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCEHypothesis',
    'ISpeechPhraseAlternates', 'ISpeechGrammarRuleStateTransitions',
    'ISpEventSink', 'SVPNormal', 'ISpXMLRecoResult', 'SPSFunction',
    'SPPHRASEELEMENT', 'SPWORDTYPE', 'SPSERIALIZEDPHRASE',
    'DISPID_SBSSeek', 'SpeechWordPronounceable',
    'SpeechPropertyResponseSpeed', 'SPSMF_SAPI_PROPERTIES',
    'SPGRAMMARSTATE', 'SRTEmulated', 'SPGS_DISABLED',
    'DISPID_SpeechPhraseElement', 'SECFEmulateResult',
    'DISPID_SRRPhraseInfo', 'ISpeechTextSelectionInformation',
    'DISPID_SVEStreamStart', 'DISPID_SGRSTType', 'SPAR_High',
    'SPSVerb', 'SPRST_INACTIVE', 'SAFT22kHz16BitMono',
    'SpeechAudioProperties', 'DISPID_SpeechBaseStream',
    'SPPS_RESERVED1', 'SREAllEvents',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_PHONEME',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRId', 'SVEWordBoundary',
    'DISPID_SRRTStreamTime', 'SAFT22kHz16BitStereo',
    'DISPID_SRCState', 'SPEI_SR_AUDIO_LEVEL', 'SVP_2', 'SpFileStream',
    'SRCS_Enabled', 'DISPID_SABIBufferSize', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVDisplayUI', 'DISPID_SPEAudioStreamOffset',
    'ISpeechAudio', 'SPRST_ACTIVE', 'SPSModifier', 'ISpAudio',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_APP', 'ISpObjectToken',
    'DISPID_SLPsCount', 'SpWaveFormatEx', 'ISpProperties', 'SVP_20',
    'SpeechVoicePriority', 'DISPID_SOTIsUISupported', 'SPPHRASERULE',
    'SINoise', 'SGDSInactive', 'ISpeechCustomStream',
    'DISPID_SDKSetLongValue', 'SRSInactive',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVWaitUntilDone', 'SDTAll',
    'DISPID_SDKEnumValues', 'DISPID_SOTCGetDataKey',
    'SGPronounciation', 'DISPID_SVSpeak', 'ISpeechMemoryStream',
    'SpeechGrammarWordType', 'SPDKL_CurrentConfig',
    'SpUnCompressedLexicon', 'eLEXTYPE_RESERVED8',
    'DISPID_SASetState', 'DISPID_SAEventHandle', 'STSF_LocalAppData',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPEDisplayAttributes', 'SAFT16kHz8BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SREPhraseStart',
    'SpeechInterference', 'SITooQuiet', 'SP_VISEME_16',
    'SREAudioLevel', 'ISpStream', 'ISpGrammarBuilder',
    'DISPID_SBSWrite', 'DISPID_SRSAudioStatus', 'DISPID_SFSClose',
    'SDKLDefaultLocation', 'DISPID_SRCERecognition',
    'DISPID_SDKGetlongValue', 'DISPID_SDKDeleteKey',
    'ISpeechRecoGrammar', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTs_NewEnum', 'SPINTERFERENCE_TOOSLOW', 'ISpPhraseAlt',
    'SAFTGSM610_11kHzMono', 'SGSExclusive', 'SPRECORESULTTIMES',
    'DISPID_SVPriority', 'SpeechAudioVolume', 'SVP_3',
    'ISpSerializeState', 'SAFTCCITT_uLaw_11kHzStereo', 'SPSHT_OTHER',
    'DISPID_SVSLastBookmark', 'SpInprocRecognizer',
    'SREPropertyNumChange', 'SPEI_TTS_PRIVATE', 'SpeechTokenKeyFiles',
    'SpInProcRecoContext', 'SPCS_DISABLED', 'SREStreamEnd',
    'SpeechPropertyComplexResponseSpeed', 'ISpDataKey',
    'DISPID_SGRClear', 'SREBookmark', 'SPCONTEXTSTATE',
    'ISpeechAudioBufferInfo', 'DISPID_SPRuleChildren',
    'ISpeechGrammarRuleStateTransition', 'ISpeechPhraseRules',
    'DISPID_SPEDisplayText', 'DISPID_SOTCSetId', 'ISpeechRecoResult2',
    'SPPHRASEREPLACEMENT', 'SPEI_TTS_AUDIO_LEVEL', 'SPLO_STATIC',
    ...
    'SPINTERFERENCE_NOSIGNAL', 'SECFNoSpecialChars',
    'SpeechEmulationCompareFlags', 'SDA_Consume_Leading_Spaces',
    'SPPS_Noun', 'DISPID_SRGIsPronounceable', 'SAFTNoAssignedFormat',
    'DISPID_SRCERequestUI', 'SP_VISEME_17',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPHRASEPROPERTY', 'SPPROPERTYINFO', 'SPSHORTCUTPAIRLIST',
    'SPSMF_UPS', 'SRTAutopause', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGDictationUnload', 'ISpPhoneticAlphabetSelection',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SDKLCurrentConfig',
    'SPFM_OPEN_READWRITE', 'SSFMCreateForWrite',
    'DISPID_SVSLastResult', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SP_VISEME_8', 'SAFTCCITT_ALaw_11kHzMono', 'SPWF_INPUT',
    'SPVOICESTATUS', 'SPSSuppressWord', 'DISPID_SGRsFindRule',
    'ISpRecoContext', 'DISPID_SPEsItem',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSLMA',
    'DISPID_SpeechVoice', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechPhraseBuilder', 'SAFT24kHz16BitStereo', 'SPAS_RUN',
    'SPSTREAMFORMATTYPE', 'SVP_9', 'ISpeechRecoResult',
    'SSTTWildcard', 'DISPID_SAStatus', 'DISPID_SRCRequestedUIType',
    'SpeechAudioFormatGUIDText', 'SAFT44kHz16BitStereo',
    'DISPID_SRCRetainedAudio', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVVoice', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTCCITT_ALaw_8kHzStereo', 'STSF_AppData',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechWaveFormatEx', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRState', 'SRSInactiveWithPurge', 'SVEAudioLevel',
    'DISPID_SRGCmdSetRuleIdState', 'SRATopLevel', 'SPEVENTENUM',
    'SPVISEMES', 'SpMMAudioOut', 'DISPID_SVSpeakCompleteEvent',
    'SAFT11kHz16BitMono', 'SPPS_Interjection',
    'DISPID_SAFGetWaveFormatEx', 'SVESentenceBoundary',
    'SPEI_INTERFERENCE', 'DISPID_SPEPronunciation', 'SVPAlert',
    'DISPID_SVStatus', 'DISPID_SVGetAudioInputs', 'SPSHT_Unknown',
    'DISPID_SRCEEndStream', 'DISPID_SRCESoundEnd',
    'SpeechRegistryLocalMachineRoot', 'SPPS_SuppressWord',
    'DISPID_SLWLangId', 'SPCT_COMMAND', 'SSTTTextBuffer',
    'SWTDeleted', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechPhraseElements', 'SDA_One_Trailing_Space',
    'DISPID_SPPName', 'DISPID_SPCLangId', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPIProperties', 'DISPID_SRGCommit', 'SVP_4',
    ...
    'SpeechFormatType', 'SPDKL_CurrentUser', 'DISPID_SPEsCount',
    'SpeechDiscardType', 'SAFTGSM610_8kHzMono', 'ISpeechLexiconWords',
    'SpeechPartOfSpeech', 'DISPID_SVResume', 'SGRSTTWildcard',
    ...
    'SpAudioFormat', 'SpeechRecoEvents', 'ISpeechPhoneConverter',
    'SGRSTTEpsilon', 'ISequentialStream', 'SVSFParseSapi',
    'DISPID_SWFEChannels', 'SPLEXICONTYPE', 'SGRSTTRule',
    'SAFTExtendedAudioFormat', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechXMLRecoResult', 'eLEXTYPE_RESERVED9',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRRRecoContext', 'SPWT_DISPLAY',
    'SAFT8kHz16BitStereo', 'DISPID_SPRuleParent', 'SPGRAMMARWORDTYPE',
    'DISPID_SRRSaveToMemory', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPRulesCount', 'SPFM_NUM_MODES', 'SpeechRecoContextState',
    'SpShortcut', 'SpSharedRecognizer', 'SpeechTokenKeyAttributes',
    'ISpeechVoice', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SMSADeviceId', 'SPVPRI_ALERT', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechRecognizerState', 'SpeechGrammarTagDictation',
    'SpCompressedLexicon', 'ISpRecoGrammar', 'SVSFParseMask',
    ...
    'SPEI_END_INPUT_STREAM', 'SPEI_START_SR_STREAM', 'SPEI_RESERVED5',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPPS_Unknown',
    'SRERequestUI', 'DISPID_SLWs_NewEnum', 'ISpResourceManager',
    'DISPID_SMSALineId', 'SPEI_UNDEFINED', 'SPCT_SUB_COMMAND',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPBOOKMARKOPTIONS', 'ISpeechFileStream', 'eLEXTYPE_PRIVATE4',
    'ISpPhrase', 'SPLO_DYNAMIC', 'SPEI_WORD_BOUNDARY',
    'SAFT16kHz16BitStereo', 'DISPID_SRCSetAdaptationData',
    'DISPID_SDKSetStringValue', 'SVP_14', 'SpeechRuleAttributes',
    'DISPID_SPPsCount', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SVEStreamEnd', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SFSOpen', 'SPBO_AHEAD', 'SFTSREngine', 'DISPID_SRRAudio',
    'SPSERIALIZEDRESULT', 'SAFT16kHz8BitStereo', 'DISPID_SLWsItem',
    'ISpeechVoiceStatus', 'SP_VISEME_6', 'SPCT_SLEEP', 'SVEAllEvents',
    'ISpeechLexiconPronunciation', 'WAVEFORMATEX', 'SRTReSent',
    'SpeechVisemeFeature', 'eLEXTYPE_RESERVED10', 'SRAONone',
    'SFTInput', 'DISPID_SVEBookmark',
    ...
    'DISPID_SRRSetTextFeedback', 'DISPID_SRGetPropertyNumber',
    'SPEI_RESERVED6', 'SAFT8kHz8BitMono', 'SpeechStreamFileMode',
    'SPINTERFERENCE_NOISE', 'DISPID_SpeechGrammarRule', 'tagSTATSTG',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRsCommit', 'SPAR_Medium', 'SpeechEngineConfidence',
    'ISpeechPhraseProperty', 'DISPID_SPRText',
    'SAFTADPCM_11kHzStereo', 'SGDSActiveWithAutoPause',
    'SAFT48kHz8BitMono', 'SpeechVoiceSkipTypeSentence',
    'SPAR_Unknown', 'SpeechGrammarState', 'SPEI_VISEME',
    'ISpeechPhraseInfoBuilder', 'SPINTERFERENCE_LATENCY_WARNING',
    'SWPKnownWordPronounceable', 'SPADAPTATIONRELEVANCE',
    'SAFT24kHz8BitMono', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPIAudioSizeTime', 'SpeechCategoryRecognizers',
    'DISPID_SPPParent', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCEventInterests', 'SVEBookmark', 'SVSFlagsAsync',
    'DISPID_SVRate', 'ISpShortcut', 'DISPID_SRGCmdLoadFromResource',
    'SRERecognition', 'DISPID_SPIAudioStreamPosition',
    'ISpNotifySource', 'SVSFNLPMask', 'DISPID_SPIEnginePrivateData',
    'SPINTERFERENCE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPRuleConfidence', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SVPOver', 'DISPID_SpeechDataKey', 'ISpeechAudioFormat',
    'SPSHORTCUTTYPE', 'SpeechGrammarRuleStateTransitionType',
    'SPSEMANTICERRORINFO', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechVoiceStatus', 'SPEI_TTS_BOOKMARK', 'SECFDefault',
    'DISPID_SRCEBookmark', 'SpNotifyTranslator', 'SVP_13',
    'SpeechBookmarkOptions', 'SVP_7', 'DISPID_SRDisplayUI',
    'DISPID_SRSClsidEngine', 'SRARoot', 'ISpeechGrammarRuleState',
    'SRSActiveAlways', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SWFEBlockAlign', 'SAFT44kHz16BitMono',
    'SECHighConfidence', 'SVP_10', 'DISPID_SPIReplacements',
    'SITooFast', 'SVSFParseAutodetect', 'SAFT8kHz16BitMono',
    'DISPID_SpeechAudio', 'DISPID_SLWType', 'STSF_FlagCreate',
    'SPRECOSTATE', 'SRAInterpreter', 'SpeechMicTraining',
    'DISPID_SRGRules', 'SPPS_Modifier', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVEViseme', 'SVP_8', 'SPWORDLIST', 'DISPID_SPIStartTime',
    'SpeechCategoryAudioIn', 'SPAR_Low', 'eLEXTYPE_PRIVATE13',
    'SPEI_SR_PRIVATE', 'SP_VISEME_0', 'SpeechVoiceSpeakFlags',
    'DISPID_SOTRemove', 'SVP_15', 'DISPID_SRAudioInputStream',
    'DISPID_SCSBaseStream', 'SREStateChange',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechPhraseProperties', 'eLEXTYPE_RESERVED6',
    'Speech_Max_Word_Length', 'SAFT11kHz16BitStereo',
    'SPEI_SOUND_END', 'SPINTERFERENCE_NONE', 'DISPID_SPRules_NewEnum',
    'SREAdaptation', 'DISPID_SPISaveToMemory', 'SASRun',
    'STCLocalServer', 'DISPID_SRCreateRecoContext',
    'ISpeechWaveFormatEx', 'SP_VISEME_11', 'eLEXTYPE_USER_SHORTCUT',
    'SPEI_FALSE_RECOGNITION', 'SVSFVoiceMask', 'DISPID_SPRuleName',
    'SSSPTRelativeToEnd', 'SpPhoneConverter', 'SAFT44kHz8BitMono',
    'SGRSTTDictation', 'DISPID_SpeechAudioFormat',
    'DISPID_SMSGetData', 'SRADynamic', 'DISPID_SPRsItem',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechRunState', 'SLTApp',
    'DISPID_SPEActualConfidence', 'DISPID_SRRAudioFormat',
    'DISPID_SVEventInterests', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPIGetDisplayAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'Speech_Default_Weight',
    'SpPhraseInfoBuilder', 'SAFTGSM610_22kHzMono', 'SpStream',
    '_ISpeechVoiceEvents', 'DISPID_SVEVoiceChange',
    'DISPID_SVIsUISupported', 'SPEI_ADAPTATION',
    'DISPID_SPIAudioSizeBytes', 'SPSNotOverriden', 'eLEXTYPE_USER',
    'ISpeechLexicon', 'DISPID_SLPs_NewEnum', 'STCInprocHandler',
    'SPBO_PAUSE', 'DISPID_SPIEngineId', 'DISPID_SPPId', 'SP_VISEME_5',
    'DISPID_SGRSTPropertyId', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRGetPropertyString', 'IStream',
    'SpeechCategoryAppLexicons', 'SVSFPersistXML',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSTsItem',
    'SSSPTRelativeToStart', 'STCInprocServer', 'SPAS_PAUSE',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechLexiconPronunciation',
    'SpVoice', 'DISPID_SpeechPhraseInfo', 'SPGS_EXCLUSIVE',
    'DISPID_SLAddPronunciation', 'DISPID_SPRs_NewEnum', 'SBONone',
    'DISPID_SOTCDefault', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRCRecognizer', 'SPPS_Verb', 'eLEXTYPE_PRIVATE15',
    'Speech_StreamPos_Asap', 'SDTAlternates',
    'DISPID_SpeechPhraseReplacements', 'SVF_Stressed',
    'DISPID_SpeechRecoResult2', 'SPWORD', 'SVEEndInputStream',
    'ISpRecoCategory', 'SPSHORTCUTPAIR', 'SGDSActive',
    'SPEI_RESERVED3', 'SVP_0', 'UINT_PTR', 'DISPID_SOTId',
    'SpCustomStream', 'SPEI_MAX_SR', 'SpeechSpecialTransitionType',
    'SVEVoiceChange', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRsDynamic', 'SREPropertyStringChange', 'SPEI_MIN_TTS',
    'ISpeechObjectTokens', 'tagSPPROPERTYINFO',
    'DISPID_SpeechMemoryStream', 'SPRULE',
    'DISPID_SpeechPhraseAlternates', 'SPWAVEFORMATTYPE', 'SDTAudio',
    'DISPID_SAVolume', 'DISPID_SPPFirstElement', 'SVSFNLPSpeakPunc',
    'SpeechVoiceEvents', 'DISPID_SPILanguageId',
    'SpeechRetainedAudioOptions', 'DISPID_SPPConfidence',
    'DISPID_SDKOpenKey', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPEAudioSizeBytes', 'SpNullPhoneConverter',
    'DISPID_SPCIdToPhone', 'SpSharedRecoContext', 'ISpeechPhraseInfo',
    'ISpEventSource', 'DISPID_SASFreeBufferSpace', 'SDTPronunciation',
    'SAFTADPCM_8kHzMono', 'DISPID_SDKDeleteValue', 'DISPID_SGRSRule',
    'DISPID_SPAs_NewEnum', 'SPEI_SOUND_START', 'SPEI_RECOGNITION',
    ...
    'DISPID_SRRecognizer', 'DISPIDSPRG', 'DISPIDSPTSI',
    'eLEXTYPE_PRIVATE10', 'DISPID_SABufferNotifySize',
    'SRAORetainAudio', 'SPCT_DICTATION', 'SpeechTokenContext',
    'ISpNotifyTranslator', 'SPWORDPRONOUNCEABLE',
    'SAFT44kHz8BitStereo', 'ISpeechDataKey', 'ISpeechAudioStatus',
    'DISPID_SPELexicalForm', 'SREStreamStart', 'SPDATAKEYLOCATION',
    'DISPID_SVEWord', 'DISPID_SDKGetStringValue',
    'SREFalseRecognition', 'DISPID_SADefaultFormat',
    'DISPID_SVSInputWordPosition', 'SECLowConfidence', 'SP_VISEME_19',
    'DISPID_SPEAudioSizeTime', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPVPRI_OVER', 'SDA_Two_Trailing_Spaces', 'SDA_No_Trailing_Space',
    'SPEI_RESERVED2', 'DISPID_SWFEExtraData', 'SAFT24kHz8BitStereo',
    ...
    'IInternetSecurityManager', 'SpResourceManager', 'DISPID_SPIRule',
    'SREPrivate', 'DISPID_SRRSpeakAudio', 'DISPID_SDKCreateKey',
    'DISPID_SOTCreateInstance', 'SPEVENT', 'SREHypothesis',
    'ISpRecognizer', 'DISPID_SDKSetBinaryValue', 'SVP_18',
    'DISPID_SGRAttributes', 'SINoSignal', 'tagSPTEXTSELECTIONINFO',
    'SPRECOCONTEXTSTATUS', 'DISPIDSPTSI_ActiveOffset', 'SGRSTTWord',
    'DISPID_SLWWord', 'ISpeechLexiconWord', 'ISpRecognizer2',
    'DISPID_SRGReset', 'SAFTADPCM_8kHzStereo', 'SpeechCategoryVoices',
    'DISPID_SPRDisplayAttributes', 'DISPID_SGRSTPropertyName',
    'DISPID_SRRDiscardResultInfo', 'SGDisplay', 'DISPID_SOTCId',
    'ISpeechPhraseElement', 'DISPID_SpeechObjectTokenCategory',
    'SVEPhoneme', 'ISpeechRecognizerStatus', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE11', 'DISPID_SBSRead', 'SpeechRecognitionType',
    'SAFT16kHz16BitMono', 'DISPID_SLPLangId', 'DISPID_SPIGetText',
    'SPEI_END_SR_STREAM', 'SAFT22kHz8BitStereo', 'DISPID_SVEPhoneme',
    'ISpLexicon', 'eLEXTYPE_PRIVATE5', 'SRTStandard', 'SASStop',
    'DISPID_SASState', 'DISPID_SPRsCount',
    'DISPID_SRSCurrentStreamNumber', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE8', 'SPFM_CREATE', 'DISPID_SVGetVoices',
    'DISPID_SVSCurrentStreamNumber', 'ISpRecoContext2',
    'ISpeechXMLRecoResult', 'DISPID_SVSInputWordLength',
    'eLEXTYPE_RESERVED4', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SMSSetData', 'SP_VISEME_20', 'SpeechAddRemoveWord',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SLRemovePronunciation',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRProfile', 'DISPID_SPPs_NewEnum',
    'DISPIDSPTSI_ActiveLength', 'ISpeechRecognizer',
    'SVEStartInputStream', 'DISPID_SASCurrentDevicePosition',
    'SLTUser', 'STCAll', 'SDTProperty', 'DISPID_SABIMinNotification',
    'SAFTNonStandardFormat', 'DISPID_SPEAudioTimeOffset', 'SRAImport',
    'DISPID_SRCResume', 'DISPID_SVVolume', 'DISPID_SGRSTText',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGetFormat',
    'DISPID_SpeechRecoResult', 'SP_VISEME_10', 'SRSActive',
    'SDTLexicalForm', 'DISPID_SOTCategory',
    'DISPID_SpeechCustomStream', 'SRADefaultToActive', 'SRAExport',
    'SVSFIsNotXML', 'SPWF_SRENGINE', 'SSFMOpenForRead',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRCCreateGrammar',
    '__MIDL_IWinTypes_0009', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechPhraseRules', 'SDKLCurrentUser', 'SGLexical',
    'DISPID_SPCPhoneToId', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SGRInitialState', 'DISPID_SPIElements',
    'DISPID_SPPChildren', 'SVF_None', 'DISPID_SPRFirstElement',
    'SPRS_ACTIVE', 'DISPID_SVSVisemeId', 'SREInterference',
    'DISPID_SGRAddState', 'SVP_16', 'IInternetSecurityMgrSite',
    'SINone', 'SPEI_MAX_TTS', 'DISPID_SGRSTRule', 'SVSFParseSsml',
    'DISPID_SGRSAddRuleTransition', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSTs_NewEnum', 'SLOStatic', 'eLEXTYPE_PRIVATE14',
    'SVP_12', 'DISPID_SPPEngineConfidence', 'DISPID_SVSpeakStream',
    'SECFIgnoreKanaType', 'SVSFUnusedFlags',
    'SpStreamFormatConverter', 'DISPID_SGRSTWeight',
    'SpeechDataKeyLocation', 'SAFTCCITT_uLaw_8kHzStereo',
    'Speech_Max_Pron_Length', 'SVSFDefault', 'DISPID_SRRTTickCount',
    'SAFT12kHz16BitStereo', 'ISpRecoGrammar2',
    'SpeechAudioFormatType', 'SVP_19', 'SITooLoud',
    'DISPID_SGRSTransitions', 'SVP_5', 'SP_VISEME_9',
    'SpeechWordType', 'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPRulesItem',
    'SRTSMLTimeout', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRRTimes',
    'DISPID_SRGRecoContext', 'ISpeechPhraseAlternate',
    'ISpMMSysAudio', 'DISPID_SRGetRecognizers',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRCEInterference',
    'DISPID_SRGDictationLoad', 'SpeechTokenShellFolder',
    'SRESoundStart', 'ISpeechGrammarRule', 'DISPID_SOTSetId',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE9',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SITooSlow',
    'SpeechLoadOption', 'SPPS_RESERVED3', 'SP_VISEME_2',
    'SpeechLexiconType', 'DISPID_SRGId', 'SRTExtendableParse',
    ...
    'DISPID_SLGetGenerationChange', 'SWTAdded', 'DISPID_SRGState',
    'SPDKL_DefaultLocation', 'DISPID_SpeechLexicon',
    'STCRemoteServer', 'SPEI_SR_BOOKMARK', 'SVSFIsXML',
    'DISPID_SLAddPronunciationByPhoneIds', 'SP_VISEME_7',
    'SPSHT_NotOverriden', 'DISPID_SVGetAudioOutputs',
    'SPAUDIOOPTIONS', 'DISPID_SRCPause', 'SPAO_RETAIN_AUDIO',
    'DISPID_SABufferInfo', 'eLEXTYPE_PRIVATE18', '_SPAUDIOSTATE',
    'SPPS_RESERVED4', 'SAFTADPCM_44kHzMono', 'STSF_CommonAppData',
    'SPFILEMODE', 'SpeechTokenIdUserLexicon',
    'DISPID_SPANumberOfElementsInResult',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVPause', 'SPEI_MIN_SR',
    'DISPID_SWFEBitsPerSample', 'SPWT_PRONUNCIATION',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechRecognizerStatus', 'SPWT_LEXICAL',
    'SPPS_NotOverriden', 'SAFT32kHz8BitMono', 'SDTDisplayText',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE16',
    'SSTTDictation', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechObjectToken', 'SAFT12kHz8BitMono',
    'SAFT11kHz8BitMono', 'DISPID_SABIEventBias', 'ISpeechMMSysAudio',
    'DISPID_SpeechAudioStatus', 'DISPID_SPACommit', 'IEnumString',
    'SP_VISEME_14', 'ISpVoice', 'SpeechEngineProperties',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_4',
    'SPEI_HYPOTHESIS', 'DISPID_SRIsUISupported',
    'DISPID_SRSetPropertyNumber', 'SpeechCategoryRecoProfiles',
    'SASClosed', 'DISPID_SRCVoice', 'SPAS_CLOSED',
    'DISPID_SPRNumberOfElements', 'DISPID_SVSInputSentenceLength',
    'SP_VISEME_18', 'SP_VISEME_15', 'SAFT24kHz16BitMono',
    'eLEXTYPE_PRIVATE17', 'eWORDTYPE_ADDED', 'SPEI_PHRASE_START',
    'SpObjectToken', 'SPEI_RESERVED1', 'ISpeechBaseStream',
    'DISPID_SRGDictationSetState', 'DISPID_SVAlertBoundary',
    'SpMMAudioIn', 'SpMemoryStream', 'DISPID_SMSAMMHandle',
    'ISpRecoResult', 'DISPID_SRCESoundStart', 'DISPID_SVSkip',
    'SPSUnknown', 'DISPID_SLWsCount', 'SP_VISEME_12', 'SSFMCreate',
    'DISPID_SLPPartOfSpeech', 'SpLexicon', 'ISpeechResourceLoader',
    'SPPARTOFSPEECH', 'DISPID_SPPValue', 'SVEPrivate',
    ...
    'SAFTADPCM_11kHzMono', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCEStartStream', 'SpeechRuleState', 'SAFTText',
    'SRCS_Disabled', 'SPPHRASE', 'SPAS_STOP', 'SP_VISEME_13',
    'LONG_PTR', 'SAFTADPCM_22kHzStereo', 'DISPID_SVEViseme',
    'SRSEDone', 'SPBO_NONE', 'SpeechTokenValueCLSID',
    'DISPID_SpeechPhoneConverter', 'SpeechUserTraining',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPPNumberOfElements',
    'SVP_17', 'SDKLLocalMachine', 'SpeechDisplayAttributes',
    'DISPID_SVSPhonemeId', 'DISPID_SVEEnginePrivate', 'SVP_1',
    'DISPID_SPAsItem', 'DISPID_SpeechRecoContext',
    'ISpeechRecoResultTimes', 'SAFT8kHz8BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'SPGS_ENABLED', 'DISPID_SOTsCount',
    'SPRULESTATE', 'SPVPRI_NORMAL', 'ISpeechLexiconPronunciations',
    'DISPID_SLPSymbolic', 'SGRSTTTextBuffer', 'DISPID_SBSFormat',
    'SLODynamic', 'SSSPTRelativeToCurrentPosition', 'ISpNotifySink',
    ...
    'DISPID_SpeechGrammarRules', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpObjectWithToken', 'SpeechAudioState', 'SBOPause',
    'DISPID_SpeechMMSysAudio', 'SAFT32kHz16BitMono',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRAlternates',
    'SGSDisabled', 'DISPID_SpeechVoiceEvent', 'SPSNoun',
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_REQUEST_UI',
    'ISpeechRecoContext', 'SPRECOGNIZERSTATUS', 'DISPID_SGRName',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPEEngineConfidence',
    'ISpeechObjectToken', 'SPPS_RESERVED2', 'SDTReplacement',
    'DISPID_SVAudioOutput', 'DISPID_SASNonBlockingIO',
    'DISPID_SLPType', 'DISPID_SpeechLexiconWords',
    'SpeechDictationTopicSpelling', 'SPTEXTSELECTIONINFO',
    'SpeechStreamSeekPositionType', 'SVP_11', 'DISPID_SLPsItem',
    'SPRST_NUM_STATES', 'SpeechTokenKeyUI',
    'DISPID_SRCEEnginePrivate', 'SGLexicalNoSpecialChars',
    'DISPID_SOTDisplayUI', 'SPCT_SUB_DICTATION',
    'SGDSActiveUserDelimited', 'DISPID_SOTDataKey', 'SPVPRIORITY',
    'SpMMAudioEnum', 'eLEXTYPE_PRIVATE6', 'SVF_Emphasis',
    'DISPID_SRCERecognitionForOtherContext',
    'ISpStreamFormatConverter', 'DISPID_SOTGetDescription',
    'SPBINARYGRAMMAR', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SAFT32kHz8BitStereo', 'DISPID_SRSSupportedLanguages',
    'SRERecoOtherContext', 'SVSFIsFilename', 'SPFM_CREATE_ALWAYS',
    'SPEI_VOICE_CHANGE', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLGetWords', 'DISPID_SGRsAdd', 'DISPID_SPRuleId',
    'DISPID_SpeechRecoResultTimes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechObjectTokens',
    'SPAO_NONE', 'DISPID_SpeechGrammarRuleState',
    ...
    'DISPID_SPARecoResult', 'Speech_StreamPos_RealTime',
    'DISPID_SOTsItem', 'DISPID_SRRTLength', 'SVP_6', 'SGSEnabled',
    'DISPID_SGRAddResource', 'SAFTDefault', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechRecognizer', 'SPCS_ENABLED', 'SRESoundEnd',
    'SPPS_Function', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVAudioOutputStream',
    'SPXRO_SML', 'DISPID_SOTGetAttribute',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechRecoProfileProperties', 'SDTRule',
    'SAFTCCITT_uLaw_8kHzMono', 'SASPause',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechLexiconWord', 'DISPID_SPAStartElementInResult',
    'SPPS_LMA', 'DISPID_SpeechPhraseReplacement',
    'SPDKL_LocalMachine', 'ISpObjectTokenCategory',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPEs_NewEnum',
    'SpeechVoiceCategoryTTSRate', 'SPPS_Noncontent',
    'SAFT48kHz16BitMono', 'DISPID_SRGCmdLoadFromObject',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPPsItem',
    'DISPID_SGRSAddWordTransition', 'ISpPhoneConverter',
    'SPSHT_EMAIL', 'SPLOADOPTIONS', 'SPFM_OPEN_READONLY',
    'DISPID_SLGetPronunciations', 'DISPID_SAFGuid',
    'DISPID_SPIGrammarId', 'SPRS_INACTIVE', 'SP_VISEME_3',
    'SPAUDIOSTATUS', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPIRetainedSizeBytes', 'SAFT48kHz16BitStereo', 'SVP_21',
    'SECNormalConfidence', 'SPCATEGORYTYPE', '_RemotableHandle',
    'SAFTADPCM_44kHzStereo', 'DISPID_SpeechFileStream',
    'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE3', 'SECFIgnoreCase',
    'DISPID_SRAudioInput', 'SP_VISEME_1',
